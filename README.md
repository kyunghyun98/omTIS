...
# Overview
Each of the four directories contains analysis code and data pertaining to topics as outlined below. Each directory has its own instructions on installation requirements and how to execute the codes.
...
Data required for running the scripts are available in Zenodo (DOI 10.5281/zenodo.17074064).

# License
This repository is made available under a CC-BY-NC-ND 4.0 International license.
